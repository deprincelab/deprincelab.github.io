...
<div id="content" style="text-align:justify;width:65%">
<font size="5">
Creating a Psi4 plugin <br>
</font>
</div>
<br>
<br>

First, you must download and install Psi4.  See the Psi4 <a href=https://github.com/psi4/psi4public>GitHub</a> page and <a href=http://psicode.org/>psicode.org</a> for detailed instructions.
...
You can see that Psi4 generated several files automatically for you.  Your
C++ code will reside in plugin.cc, and you can interface with other modules
in Psi4 through the driver in pymodule.py.  
...
Let\'s add a print statement using Psi4\'s printer class \'outfile\':
<br>
<br>
<pre class="prettyprint">
...
valid Psi4 options, so you may not need to introduce any new ones.   
<br>
<br>

Now, let\'s compile and run the plugin.  You can use Psi4 to generate
...
What you should see is some text indicating that Psi4 has generated 
